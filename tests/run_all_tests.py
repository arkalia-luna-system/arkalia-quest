...
def generate_report(all_results):
    ...
    stable_results = [r for r in all_results if any(x in r["test_name"] for x in ["stable", "security", "performance", "gamification", "complet_arkalia"])]
    script_results = [r for r in all_results if r["test_name"] in ["test_boutons_rapide", "test_tutoriel", "test_interface_complete", "test_os2142_complete", "test_phase1_complete"]]
...
def main():
    ...
    print(f"🎮 Tests d'expérience: {report['categories']['experience_tests']['successful']}/{report['categories']['experience_tests']['count']}")
    print(f"🔧 Tests de stabilité: {report['categories']['stable_tests']['successful']}/{report['categories']['stable_tests']['count']}")
    print(f"📜 Tests de scripts: {report['categories']['script_tests']['successful']}/{report['categories']['script_tests']['count']}")
