...
- **Visuel minimal unifié** : Une seule feuille `static/css/arkalia-minimal.css` (fond sombre, texte lisible, accent bleu) chargée sur **toutes** les pages à la place de la refonte 2026. Rendu sobre, cohérent et sans conflits. Voir [REPARTIR_SUR_DES_BASES_SANES.md](REPARTIR_SUR_DES_BASES_SANES.md). L’ancienne refonte « Nuit émotionnelle » reste documentée dans [REFONTE_VISUELLE_2026.md](REFONTE_VISUELLE_2026.md) et le fichier `arkalia-visual-2026.css` est conservé en option.
