...
class MissionHandler:
    ...
    def load_all_data(self):
        ...
        new_mission_names = ['prologue.json', 'acte_1.json', 'acte_2.json', 'acte_3.json', 'acte_4.json', 'acte_5.json', 'acte_6.json', 'epilogue.json']
    ...
    def get_current_acte(self, profil: Dict[str, Any]) -> str:
        ...
        acte_order = ['prologue', 'acte_1', 'acte_2', 'acte_3', 'acte_4', 'acte_5', 'acte_6', 'epilogue']
    ...
    def execute_mission_step(self, mission_id: str, step_id: str, profil: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def execute_commande(self, commande: str, profil: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if commande.startswith('luna_'):
            return {"success": True, "message": "Commande LUNA exécutée", "ascii": "luna_contact"}
            ...
            return {"success": True, "message": "Génération terminée", "ascii": "success"}
        else:
