...
class WebSocketManager:
    ...
    def handle_chat_message(self, session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def complete_mission(self, room_id: str, session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def end_challenge(self, room_id: str) -> Dict[str, Any]:
        ...
        winner = ranking[0]['player_name'] if ranking and ranking[0]['status'] == 'completed' else None
    ...
    def broadcast_to_room(self, room_id: str, message: Dict[str, Any], exclude_session: Optional[str] = None):
