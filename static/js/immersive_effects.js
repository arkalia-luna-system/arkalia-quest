...
class ImmersiveEffectsEngine {
    ...
    init() {
        console.log("🌟 Initialisation du moteur d'effets immersifs...");
        ...
        this.isActive = true;
        console.log("✅ Moteur d'effets immersifs initialisé");
    }
    ...
    updateLunaEmotion(emotionData) {
        ...
        console.log(`🌙 LUNA émotion: ${emotion} (intensité: ${intensity})`);
...
console.log("🌟 Moteur d'effets immersifs chargé et prêt !"); 