...
class WebSocketManager:
    ...
    def handle_chat_message(
        self, _session_id: str, data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def handle_ping(self, _session_id: str, _data: Dict[str, Any]) -> Dict[str, Any]:
        """Gère un ping pour maintenir la connexion"""
        return {"type": "pong", "timestamp": time.time()}

    def start_challenge(self, room_id: str, _session_id: str) -> Dict[str, Any]:
        """Démarre un défi"""
